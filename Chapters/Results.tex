...
\begin{figure}
	\subfloat[\emph{False positive} slika naizgled prazna no na njoj je neodređeni element, nevidljiv zbog nepravilnih transformacija primjenjenih ma njemu] {%
		\includegraphics[width=0.5\linewidth]{false_positive} %
		\label{fig:FalsePositive}
	}
	\subfloat[Prva detekcija računalno generirane brojke 3 na slici uz mali postotak pouzdanosti] {%
...
\begin{figure}
	\subfloat[Pouzdanost i preciznost nakon $350000$ koraka] {%
		\includegraphics[width=0.5\linewidth]{first_generated_eqn} %
		\label{fig:ExpressionA}
	}
	\subfloat[Pouzdanost i preciznost nakon $500000$ koraka] {%
		\includegraphics[width=0.5\linewidth]{last_generated_eqn} %
